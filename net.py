...
class Restormer_Decoder(nn.Module):
    ...
    # def forward(self, inp_img, feature,weight,stage):
        # if stage==1:
        #     out_enc_level0 = feature
        # elif stage==2:
        #     # [feature_F_B, feature_F_D],[w_b, w_d]
        #     # out_enc_level0 = feature[0]*weight[0]+feature[1]*weight[1]
        #     out_enc_level0 = torch.cat((torch.mul(feature[0],weight[0]), torch.mul(feature[1],weight[1])), dim=1)
